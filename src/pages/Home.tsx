                ...
                <div className="pointer-events-none absolute inset-0 p-8 md:p-12 flex items-center">
                  <div className="max-w-2xl">
                    ...
                    <p className="mt-4 text-lg text-neutral-300 max-w-xl">
                      I build planning + learning systems for robotic manipulation — from symbolic
                      planning/control to multi-task RL and sim-to-real pipelines.
                    </p>
              ...
              events={[
                {
                  ...
                  description: "Received Russian Government Scholarship",
                  image:
                    "https://images.unsplash.com/photo-1523580494863-6f3031224c94?auto=format&fit=crop&w=900&q=60",
                  category: "Education",
                },
                {
                  id: "t-2021",
                  ...
                  description: "Moved to Moscow, Russia",
                  image:
                ...
                },
                {
                  id: "t-2026",
                  date: "2026",
                  title: "Joined MBZUAI as Research Engineer",
                  description:
                    "Paper accepted for ICRA'26 (first A* paper)\nSubmitted paper for RSS'26",
                  image:
