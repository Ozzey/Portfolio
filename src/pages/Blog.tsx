...
const newsletters = [
  {
    ...
    desc: "Short-form insights from ongoing research and experiments.",
    gradientFrom: "#a78bfa",
    gradientTo: "#f472b6",
  },
  {
    title: "Lab Updates",
    desc: "Milestones, demos, and behind-the-scenes updates.",
    gradientFrom: "#34d399",
    gradientTo: "#22c55e",
  },
];
...
function NewsletterCard({
  ...
  return (
    <div className="group relative w-[320px] h-[360px] m-[40px_30px] transition-all duration-500">
      <span
        className="absolute top-0 left-[50px] w-1/2 h-full rounded-lg transform skew-x-[15deg] transition-all duration-500 group-hover:skew-x-0 group-hover:left-[20px] group-hover:w-[calc(100%-90px)]"
        style={{ background: `linear-gradient(315deg, ${gradientFrom}, ${gradientTo})` }}
      />
