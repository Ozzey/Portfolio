...
const GlassCard = React.forwardRef(function GlassCard(
  ...
  return (
    <div
      ref={ref}
      className={`group ${expanded ? expandedHeight : collapsedHeight} w-[320px] [perspective:1000px] transition-[height] duration-300 ease-out ${className ?? ""}`}
      {...props}
    >
      <div
          ...
          <div className="px-7 pt-[70px] pb-0">
            ...
            {expanded && (
              <div className="mt-4 rounded-xl border border-white/10 bg-white/5 p-4">
                ...
                <p className="mt-2 text-[12px] text-zinc-300 leading-relaxed">
                  {abstract}
                </p>
              </div>
            )}
